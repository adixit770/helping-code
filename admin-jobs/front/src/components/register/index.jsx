                            ...
                            <div className="form-login-cover">
                              ...
                              <form className="login-register text-start mt-20" action="#">
                                ...
                                <div className="login_footer form-group d-flex justify-content-between">
                                  ...
                                  </label><Link className="text-muted" to="#">Lean more</Link>
                                </div>
                                <div className="form-group">
                                  <button className="btn btn-brand-1 hover-up w-100" type="submit" name="login">Submit &amp; Register</button>
                                </div>
                                <div className="text-muted text-center">Already have an account? <Link to="/Login">Sign in</Link></div>
                              </form>
                            </div>
                          </div>
                        </div>
                ...
                <div className="modal-body pl-30 pr-30 pt-50">
                  ...
                  <form className="login-register text-start mt-20 pb-30" action="#">
                    ...
                    <div className="login_footer form-group d-flex justify-content-between">
                      <label className="cb-container">
                        <input type="checkbox" /><span className="text-small">Agree our terms and policy</span><span className="checkmark" />
                      </label><Link className="text-muted" to="page-contact.html">Lean more</Link>
                    </div>
                    <div className="form-group">
                      <button className="btn btn-default hover-up w-100" type="submit" name="login">Apply Job</button>
                    </div>
                    <div className="text-muted text-center">Do you need support? <Link to="page-contact.html">Contact Us</Link></div>
                  </form>
                </div>
              </div>
            </div>
