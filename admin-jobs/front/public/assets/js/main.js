(function($) {
  ...
  function mobileHeaderActive() {
    ...
    console.log("navbarTrigger===>", navbarTrigger);
  ...
  $(".swiper-group-10").each(function() {
    const swiper_10_items = new Swiper(this, {
      spaceBetween: 20,
      slidesPerView: 10,
      slidesPerGroup: 2,
      loop: true,
  ...
  $(".swiper-group-1").each(function() {
    const swiper_1_items = new Swiper(this, {
      spaceBetween: 30,
      slidesPerView: 1,
      loop: true,
      navigation: {
  ...
  $("#circle-staticstic-demo").circliful({
    ...
    textStyle:
      "font-size: 20px; font-weight: bold; font-family: 'Plus Jakarta Sans', sans-serif",
    fontColor: "#05264E",
    fillColor: "#d8e0fd",
