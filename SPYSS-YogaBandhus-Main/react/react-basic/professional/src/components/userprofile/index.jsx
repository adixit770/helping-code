        ...
        <div className="col-md-9">
          <div className="user_profile">
            ...
            <div className="profile_body position-relative">
              ...
              <h1 className="font-24 font-B m-0">Herry Welsh</h1>
              <p className="font-16 font-M text-secondary mb-0">Denver, CEO</p>
              ...
              <div className="mutual_connecton d-flex align-items-center w-100">
                ...
                <div className="mutual_connection_details">
                  <span className="connection_count font-16 font-M">
                    12 mutual connections:
                  </span>
                  <sapn className="connection_pera font-16 font-M text-secondary">
                    Kethi Ferrazzi, jhon Densal , and 5 others
                  </sapn>
                </div>
              </div>
              <div className="following_buttons d-flex align-items-center">
                ...
                <a href="#" className="btn btn-default rounded-pill me-3">
                  Cancel Request
                </a>
                <a href="#" className="btn btn-primary-outline rounded-pill">
                  Message
                </a>
              </div>
            </div>
